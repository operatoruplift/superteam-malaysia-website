        ...
        <div className="relative overflow-hidden">
          ...
          <div className="flex animate-scroll-left hover:[animation-play-state:paused] w-max">
            {doubled.map((partner, i) => (
              ...
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full overflow-hidden group-hover:scale-110 transition-transform duration-300 flex items-center justify-center">
                  <Image
                    src={partner.logoSrc}
                    alt={partner.name}
                    width={48}
                    height={48}
                    className="w-10 h-10 sm:w-12 sm:h-12 object-cover grayscale opacity-50 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-400"
                    unoptimized
                  />
                </div>
